                            ...
                            <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                                <div>
                                    ...
                                    <input type="text" id="product-name" name="name"
                                        ...
                                        placeholder="Masukkan nama siswa" value="{{ $siswa->name }}" required>
                                </div>
                                <div>
                                    ...
                                    <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-transparent">
                                        <select
                                            ...
                                            <option value="{{ $item->id }}"
                                                class="text-gray-700 dark:bg-gray-900 dark:text-gray-400"
                                                {{ $siswa->class_id == $item->id ? 'selected' : '' }}>
                                                {{ $item->name }}
                                            </option>
                                            @endforeach
                                        </select>
                                ...
                                <div>
                                    ...
                                    <input type="text" id="product-name" name="school"
                                        class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30"
                                        placeholder="Masukkan asal sekolah" value="{{ $siswa->school }}" required>
                                </div>
                                <div>
                                    <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                    ...
                                    <div class="relative">
                                        <input type="date" name="enter_date" placeholder="Pilih tanggal masuk"
                                            ...
                                            value="{{ $siswa->enter_date }}" required>
