        ...
        <div class="overflow-hidden rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            <div
                ...
                <div class="flex flex-wrap items-end justify-between gap-3">
                    <form action="/admin/siswa" method="GET" class="flex items-center gap-2">
                        <div class="relative">
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-800">
                        @forelse ($siswa as $item)
                            <tr class="transition hover:bg-gray-50 dark:hover:bg-gray-900">
                                ...
                                <td class="px-5 py-4 whitespace-nowrap">
                                    <p class="text-sm text-gray-500 dark:text-gray-400">
                                        {{ Carbon::parse($item->enter_date)->translatedFormat('D, d M Y') }}</p>
                                </td>
                                <td class="px-5 py-4 whitespace-nowrap">
                                    <div x-data="{ open: false }" class="relative flex justify-start">
                                        ...
                                        <div x-show="open" @click.outside="open = false"
                                            ...
                                            <form onsubmit="return confirm('Apakah yakin menghapus siswa?');"
                                                action="/admin/siswa/{{ $item->id }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button
