        ...
        <div class="overflow-hidden rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            <div
                ...
                <div class="flex flex-wrap items-end justify-between gap-3">
                    <form action="/admin/tutor" method="GET" class="flex items-center gap-2">
                        <div class="relative">
                                ...
                                <td class="px-5 py-4 whitespace-nowrap">
                                    <div x-data="{ open: false }" class="relative flex justify-start">
                                        ...
                                        <div x-show="open" @click.outside="open = false"
                                            ...
                                            style="display: none;">
                                            <a href="/admin/tutor/{{ $item['id'] }}/edit"
                                            ...
                                            <form onsubmit="return confirm('Apakah yakin menghapus tutor?');"
                                                action="/admin/tutor/{{ $item->id }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button
