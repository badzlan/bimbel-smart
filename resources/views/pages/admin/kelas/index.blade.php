...
@php
    // Data diubah menjadi data kelas
    $kelas = [
        [
            'id' => 1,
            'nama_kelas' => 'Kelas 9A',
            'nama_mentor' => 'Badzlan Nur S.Tr.Kom., M.Kom.',
            'jumlah_murid' => 18,
        ],
        [
            'id' => 2,
            'nama_kelas' => 'Kelas 11 IPA 2',
            'nama_mentor' => 'Andi Wijaya S.Pd., M.Pd.',
            'jumlah_murid' => 25,
        ],
        [
            'id' => 3,
            'nama_kelas' => 'Kelas 6B',
            'nama_mentor' => 'Rina Hartono S.Si.',
            'jumlah_murid' => 22,
        ],
        [
            'id' => 4,
            'nama_kelas' => 'Kelas 8C',
            'nama_mentor' => 'Siti Aminah S.Hum., M.A.',
            'jumlah_murid' => 20,
        ],
        [
            'id' => 5,
            'nama_kelas' => 'Kelas 12 IPS 1',
            'nama_mentor' => 'Guntur Perkasa S.T., M.T.',
            'jumlah_murid' => 30,
        ],
    ];
@endphp
                        ...
                        @forelse ($kelas as $item)
                            <tr class="transition hover:bg-gray-50 dark:hover:bg-gray-900">
                                ...
                                <td class="px-5 py-4 whitespace-nowrap">
                                    <span
                                        class="text-sm font-medium text-gray-700 dark:text-gray-400">{{ $item['nama_kelas'] }}</span>
                                </td>
                                <td class="px-5 py-4 whitespace-nowrap">
                                    <p class="text-sm text-gray-500 dark:text-gray-400">{{ $item['nama_mentor'] }}</p>
                                </td>
                                <td class="px-5 py-4 whitespace-nowrap">
                                    <p class="text-sm text-gray-500 dark:text-gray-400">{{ $item['jumlah_murid'] }} Murid
                                    </p>
                                </td>
                                <td class="px-5 py-4 whitespace-nowrap">
