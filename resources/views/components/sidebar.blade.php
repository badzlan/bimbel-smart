        ...
        <nav>
            <div>
                ...
                <ul class="mb-6 flex flex-col gap-1">
                    <li>
                        <a href="{{ url('/admin/dashboard') }}" class="menu-item group {{ $title === 'Dashboard' ? 'menu-item-active' : 'menu-item-inactive' }}">
                    ...
                    <li>
                        <a href="{{ url('/admin/kelola-kelas') }}" class="menu-item group {{ $title === 'Kelola Kelas' ? 'menu-item-active' : 'menu-item-inactive' }}">
                    ...
                    <li>
                        <a href="{{ url('/admin/kelola-tutor') }}" class="menu-item group {{ $title === 'Kelola Tutor' ? 'menu-item-active' : 'menu-item-inactive' }}">
                            <svg width="24" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg" transform="rotate(0 0 0)">
                    ...
                    <li>
                        <a href="{{ url('/admin/kelola-siswa') }}" class="menu-item group {{ $title === 'Kelola Siswa' ? 'menu-item-active' : 'menu-item-inactive' }}">
                    ...
                    <li>
                        <a href="{{ url('/admin/rekap-absensi') }}" class="menu-item group {{ $title === 'Rekap Absensi' ? 'menu-item-active' : 'menu-item-inactive' }}">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li>
                        <a href="{{ url('/admin/total-fee') }}" class="menu-item group {{ $title === 'Total Fee' ? 'menu-item-active' : 'menu-item-inactive' }}">
                ...
                <ul class="mb-6 flex flex-col gap-1">
                    <li>
                        <a href="{{ url('/profile') }}" class="menu-item group {{ $title === 'Profile' ? 'menu-item-active' : 'menu-item-inactive' }}">
                    ...
                    <li>
                        <a href="{{ url('/signout') }}" class="menu-item group {{ $title === 'Sign Out' ? 'menu-item-active' : 'menu-item-inactive' }}">
